...
const weekToPercentages = (week: Week): Array<number> => {
    ...
    switch (week) {
        case 1: {
            return [...warmupWeights, 0.65, 0.75, 0.85];
        }
        case 2: {
            return [...warmupWeights, 0.7, 0.8, 0.9];
        }
        case 3: {
            return [...warmupWeights, 0.75, 0.85, 0.95];
        }
    }
};
...
const weekToSetsReps = (week: Week): Array<number> => {
    ...
    switch (week) {
        case 1: {
            return [...warmupReps, 5, 5, 5];
        }
        case 2: {
            return [...warmupReps, 3, 3, 3];
        }
        case 3: {
            return [...warmupReps, 5, 3, 1];
        }
    }
};
